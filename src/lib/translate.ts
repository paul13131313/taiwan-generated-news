...
- 中国語の慣用表現を自然な日本語に変える
- 一般用語は必ず日本語に翻訳する。固有名詞（人名・会社名・サービス名・商品名）は中国語のままでよいが、それ以外の一般用語が中国語のまま残ってはならない（例: 預賽→予選ラウンド、決賽→決勝、優惠→割引、上架→リリース、評估→評価、方案→計画、措施→措置、營收→売上高、虧損→赤字、獲利→黒字、產能→生産能力、良率→歩留まり、晶片→チップ、首映→封切り、票房→興行収入、晶圓代工→ファウンドリ（半導体受託製造）、城市→都市、午茶→アフタヌーンティー、買2送2→2個買うと2個無料、買一送一→1個買うと1個無料）
- 【最終チェック】記事全体を通して、固有名詞以外に中国語の一般用語が混在していないか確認すること。固有名詞として残した中国語はglossaryで読み方と意味を補足する

## 台湾固有名詞の用語解説ルール（厳守・全記事共通）
記事本文中には括弧注を入れず、そのまま記載する。
代わりに、各記事オブジェクトにglossary配列を含め、その記事に登場する台湾の固有名詞で日本人読者が知らない可能性が高いものを解説する。
用語解説はセクション単位ではなく、各記事単位でつける（hero、headlines各記事、business.articles各記事、culture.featured各記事、culture.articles各記事、lifeInTaiwan.articles各記事）。
