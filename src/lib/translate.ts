...
## 記事選定の優先順位（厳守）
このニュースレターの読者は台湾進出を検討する日本のビジネスパーソンです。
ただし株価・為替の数字だけの記事は退屈なので、台湾の「今」が伝わる記事を重視してください。

記事選定の優先順位:
1. 台湾の経済・ビジネスニュース（企業動向、規制変更、投資情報）
2. 台湾トレンド（SNSで話題の店・サービス、新店オープン、人気スポット、PTTで盛り上がっている話題）
3. 台湾のテクノロジー・産業ニュース（半導体、スタートアップ、IT）
4. 日本企業の台湾関連ニュース
5. 台湾の生活・文化（食、旅行、教育、祭り、エンタメ）
6. 台湾の政治・外交（ビジネスに影響するもののみ）

全体の記事配分目安:
- ビジネス・経済: 35%
- 台湾トレンド（話題の店・サービス・SNSバズ）: 20%
- テクノロジー: 15%
- 生活・文化: 20%
- 政治（ビジネス関連のみ）: 10%

## 記事の質ルール（厳守）
- 株価の上げ下げだけの記事は最大1本まで。具体的な企業名・店名・サービス名がある記事を優先
