...
## 台湾固有名詞の用語解説ルール（厳守・全セクション共通）
記事本文中には括弧注を入れず、そのまま記載する。
代わりに、各セクション（hero、business、japanEntry、culture、lifeInTaiwan）のJSONにglossary配列を含め、そのセクションの記事に登場する台湾の固有名詞で日本人読者が知らない可能性が高いものを解説する。
...
- { "term": "全聯", "reading": "チェンリエン", "explanation": "台湾最大のスーパーマーケットチェーン" }
- { "term": "立法院", "explanation": "台湾の国会に相当" }
...
- imagePromptは英語40語以内
- 各セクションのglossaryは、そのセクションの記事に登場する台湾固有名詞の解説（3〜6語目安）。該当がなければ空配列[]
