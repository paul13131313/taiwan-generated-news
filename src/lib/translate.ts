...
- 中国語の慣用表現を自然な日本語に変える
- 一般用語は必ず日本語に翻訳する。固有名詞（人名・会社名・サービス名・商品名）は中国語のままでよいが、それ以外の一般用語が中国語のまま残ってはならない（例: 預賽→予選ラウンド、決賽→決勝、優惠→割引、上架→リリース、評估→評価、方案→計画、措施→措置、營收→売上高、虧損→赤字、獲利→黒字、產能→生産能力、良率→歩留まり、晶片→チップ、首映→封切り、票房→興行収入）
