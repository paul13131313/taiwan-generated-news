...
## 台湾固有名詞の解説ルール（厳守・全セクション共通）
台湾の固有名詞（地名、人名、企業名、政府機関名、文化用語など）が登場する場合、日本人読者が知らない可能性が高いものには初出時に括弧で読み方と簡潔な説明を添えること。

フォーマット例:
- 鼎泰豊（ディンタイフォン、小籠包で有名な飲食チェーン）
- 行政院（台湾の内閣に相当）
- 高雄（カオシュン、台湾南部の主要都市）
- 蔡英文（ツァイ・インウェン、前総統）
- 悠遊カード（ヨウヨウカード、台湾版Suica）
- 全聯（チェンリエン、台湾最大のスーパーマーケットチェーン）
- 立法院（台湾の国会に相当）

解説の基準:
- 日本人が知らなそうなもの全般に付ける
- 台北、台湾、TSMCなど日本でも広く知られているものには不要
- 同じ号の中で2回目以降に登場する場合は解説不要（初出のみ）
- 解説は短く（読み方＋10字程度の説明）
